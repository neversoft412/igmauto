...
return [
    'zenddevelopertools' => [
        ...
        'profiler' => [
            ...
            /**
             * Contains a tag with all collector the profiler should run. Zend Developer Tools ships with
        ...
        'events' => [
            ...
            /**
             * Contains a tag with all event-level collectors that should run. Zend Developer Tools ships with 'time'
        ...
        'toolbar' => [
            ...
            /**
             * Contains a tag with all collector toolbar templates. The name  of the array key must be same as the name
             * of the collector.
             *
